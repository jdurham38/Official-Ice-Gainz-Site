...
const BulkingCollection = () => {
  ...
  // Filter products with collection name "bulk"
  const bulkProducts = products.filter((product) => product.collection === 'Bulking');
...
export default BulkingCollection;
