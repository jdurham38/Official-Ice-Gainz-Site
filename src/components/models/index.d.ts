...
type EagerIcecream = {
  readonly [__modelMeta__]: {
    identifier: ManagedIdentifier<Icecream, 'id'>;
    readOnlyFields: 'createdAt' | 'updatedAt';
  };
  readonly id: string;
...
export declare type Icecream = LazyLoading extends LazyLoadingDisabled ? EagerIcecream : LazyIcecream

export declare const Icecream: (new (init: ModelInit<Icecream>) => Icecream) & {
  copyOf(source: Icecream, mutator: (draft: MutableModel<Icecream>) => MutableModel<Icecream> | void): Icecream;
}
